...
const ProfilePassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        } else if (!formData.password_previous.trim().match(regExpPassword)) {
            validationErrors.password_previous = 'Le mot de passe est invalide. Il doit contenir au moins 8' +
        ...
        if (formData.password === formData.password_previous) {
